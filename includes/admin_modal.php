  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h3 class="modal-title text-center mb-3 fw-bold" id="staticBackdropLabel">ADMIN LOGIN</h3>
...
<div class="d-grid gap-2">
  <button class="btn btn-warning text-white fw-bold search-btn" type="submit">SIGN IN</button>

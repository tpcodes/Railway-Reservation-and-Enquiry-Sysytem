...
function countrySelector($defaultCountry = "", $id = "", $name = "", $classes = ""){
	...
	foreach($countryArray as $code => $country){
		...
		$output .= "<option value='".$countryName."' ".(($code==strtoupper($defaultCountry))?"selected":"").">".$countryName."</option>";
	}
...
function countrySelector1($defaultCountry = "", $id = "", $name = "", $classes = ""){
    global $countryArray; // Assuming the array is placed above this function
    
    $output = "<select id='".$id."' name='".$name."' class='".$classes."'>";
    $output .=  "<option selected disabled>Select Nationality</option>";
